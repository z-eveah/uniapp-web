  ...
  <view class="uni-calendar">
    ...
    >
      <view class="uni-calendar__header">
        ...
        <text class="uni-calendar__backtoday" @click="backtoday" v-if="showBackToday">回到今天</text>
      </view>
      ...
      <view v-if="!insert" class="btn-cont">
        <view @click="close">
          <text class="btn-cancel">重置</text>
        </view>
        <view @click="confirm">
          <text class="btn-ok">确定</text>
        </view>
      </view>
    </view>
  </view>
